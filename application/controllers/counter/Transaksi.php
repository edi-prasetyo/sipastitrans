...
class Transaksi extends CI_Controller
{
    ...
    public function create()
    {
        ...
        $price = $jarak * $product->price + $product->start_price;
        $charge = $product->service_charge;
        $total_price        = $price + $charge;

        // var_dump($product->service_charge);
        // die;
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success text-center">Data  telah ditambahkan </div>');
