<div class="card">
    <div class="card-header bg-white">
        ...
        <!-- <div class="card-tools">
            <a class="btn btn-primary" href="<?php echo base_url('admin/products/create'); ?>"> <i class="fa fa-plus"></i> Buat Produk</a>
        </div> -->
        ...
        <table class="table">
            ...
            foreach ($product as $product) { ?>
                <tr>
                    ...
                    <td>Rp. <?php echo number_format($product->service_charge, '0', ',', '.'); ?></td>
                    <td>
