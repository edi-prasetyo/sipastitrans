<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <div class="form-group row">
            <label class="col-lg-3 col-form-label">Service Charge
            </label>
            <div class="col-lg-6">
                <input type="text" class="form-control" name="service_charge" placeholder="Service Charge" value="<?php echo $product->service_charge; ?>">
                <?php echo form_error('service_charge', '<small class="text-danger">', '</small>'); ?>
            </div>
        </div>
